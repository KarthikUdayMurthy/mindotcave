...
export class CardComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    if(this.cardServ.cardViewStatus.side === "front") {
      ...
      this.showBack = false;
      setTimeout(() => {
        this.showDetail(this.cardServ.cardViewStatus.detailType, this.cardServ.cardViewStatus.detailOrg);
      }, 300);
    }
  }
  ...
  showDetail(typ = "", org = ""): void {
    ...
    this.showBack = true;
    this.cardServ.cardViewStatus =  {side: "back", detailType: typ, detailOrg: org};
  }

  showFront(): void {
    this.cardServ.cardViewStatus =  {side: "front", detailType: "", detailOrg: ""};
    this.cardServ.onEditGoToSlide = 0;
    this.showBack = false;
    this.cardbackHdr = "";
    this.cardDetailShow = "";
